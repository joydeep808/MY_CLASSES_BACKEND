...
Router.route("/login").patch((0, Student_validator_1.StudentLoginValidator)(), validate_1.validateErrors, AuthCheck_Middleware_1.teacherAuthCheck, Teacher_Controllers_1.TeacherLogin);
